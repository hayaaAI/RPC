...
namespace ProxyEmitter
{
    public static class ProxyEmitter
    {
        ...
        public static Type CreateType(Type baseType, Type interfaceType)
        {
            ...
            //    return type;
            // Not cached, create
            var type = EmitProxyType(baseType, interfaceType);
            // Cache
        ...
        private static Type EmitProxyType(Type baseType, Type interfaceType)
        {
            ...
            foreach (var method in methods)
            {
                ...
                EmitInterfaceMethod(tBuilder, interfaceName, method, invokeMethod, convertMethod);
            }
        ...
        private static void EmitInterfaceMethod(TypeBuilder tBuilder, string interfaceName, MethodInfo method, MethodInfo invokeMethod, MethodInfo convertMethod)
        {
            ...
            EmitInvokeArguments(ilGen, interfaceName, method, pTypes);
        ...
        private static void EmitInvokeArguments(ILGenerator ilGen, string interfaceName, MethodInfo method, Type[] pTypes)
        {
            // Zero-th one, namespace
            DoEmit(ilGen, OpCodes.Ldstr, interfaceName);
