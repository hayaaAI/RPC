package hayaa.rpc.common.util;

import hayaa.common.JsonHelper;
import hayaa.rpc.common.config.CommunicationPrimitives;
...
public class RpcDataHelper {
     ...
     * @return
     */
    public static Object parseServerData(RpcDataValue rpcDataValue,Class classObj) {
        Object result = null;
